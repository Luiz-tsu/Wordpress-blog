...
function RichTextWrapper({
  ...
  const selector = (select) => {
    ...
    const { getSelectionStart: getSelectionStart2, getSelectionEnd: getSelectionEnd2, getBlockEditingMode } = select(blockEditorStore);
  ...
  const { selectionStart, selectionEnd, isSelected, isContentOnly } = useSelect(selector, [
    clientId,
    identifier,
    instanceId,
    originalIsSelected,

...
function LinkPreview({
  ...
  return /* @__PURE__ */ jsx(
    Flex,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { gap: 0, children: [
        /* @__PURE__ */ jsxs(
          Flex,
          {
              ...
              /* @__PURE__ */ jsx(
                Flex,
                {
                  ...
                  children: !isEmptyURL ? /* @__PURE__ */ jsxs(Fragment, { children: [
                    ...
                    !isUrlRedundant && /* @__PURE__ */ jsx("span", { className: "block-editor-link-control__preview-info", children: /* @__PURE__ */ jsx(Truncate, { numberOfLines: 1, children: displayURL }) })

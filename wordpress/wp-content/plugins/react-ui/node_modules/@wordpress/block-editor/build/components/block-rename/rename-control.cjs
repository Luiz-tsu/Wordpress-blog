...
var rename_control_exports = {};
__export(rename_control_exports, {
  default: () => BlockRenameControl
});
module.exports = __toCommonJS(rename_control_exports);
...
function BlockRenameControl({ clientId }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    renamingBlock && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
//# sourceMappingURL=rename-control.cjs.map

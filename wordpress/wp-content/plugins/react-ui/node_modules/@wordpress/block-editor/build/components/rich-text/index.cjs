...
function RichTextWrapper({
  ...
  const selector = (select) => {
    ...
    const { getSelectionStart: getSelectionStart2, getSelectionEnd: getSelectionEnd2, getBlockEditingMode } = select(import_store.store);
  ...
  const { selectionStart, selectionEnd, isSelected, isContentOnly } = (0, import_data.useSelect)(selector, [
    clientId,
    identifier,
    instanceId,
    originalIsSelected,

...
var import_content_lock = require("../content-lock/index.cjs");
var import_block_rename = require("../block-rename/index.cjs");
var import_block_visibility = require("../block-visibility/index.cjs");
var import_edit_section_menu_item = require("./edit-section-menu-item.cjs");
    ...
    Slot,
    {
      ...
      children: (fills) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.MenuGroup, { children: [
          ...
          showRenameButton && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          fills,
          selectedClientIds.length === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_content_lock.ModifyContentOnlySectionMenuItem,
            {
              clientId: selectedClientIds[0],
              onClose: fillProps?.onClose
            }
          ),
          fillProps?.count === 1 && !isContentOnly && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(

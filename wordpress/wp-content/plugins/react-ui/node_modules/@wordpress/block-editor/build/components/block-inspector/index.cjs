...
var import_block_visibility_info = __toESM(require("../block-visibility/block-visibility-info.cjs"));
...
var BlockInspectorSingleBlock = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "block-editor-block-inspector", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_block_visibility_info.default, { clientId: renderedBlockClientId }),

...
function ActivityItem(props) {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs(Stack, { direction: "row", gap: "md", justify: "start", align: "flex-start", children: [
        /* @__PURE__ */ jsx(
          Stack,
          {
            direction: "column",
        ...
        primaryActions.length < eligibleActions.length && /* @__PURE__ */ jsx("div", { className: "dataviews-view-activity__item-actions", children: /* @__PURE__ */ jsx(
          ItemActions,
          {
            item,

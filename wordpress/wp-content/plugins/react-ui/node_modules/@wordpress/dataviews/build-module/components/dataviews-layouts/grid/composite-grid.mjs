...
var GridItem = forwardRef(function GridItem2({
  ...
  return /* @__PURE__ */ jsxs(
    Stack,
    {
      ...
      children: [
        shouldRenderMedia && /* @__PURE__ */ jsx(
          ItemClickWrapper,
          {
            item,
            isItemClickable,
        ...
        hasBulkActions && shouldRenderMedia && /* @__PURE__ */ jsx(
        ...
        !showTitle && shouldRenderMedia && !!actions?.length && /* @__PURE__ */ jsx("div", { className: "dataviews-view-grid__media-actions", children: /* @__PURE__ */ jsx(ItemActions, { item, actions, isCompact: true }) }),
        ...
        /* @__PURE__ */ jsxs(Stack, { direction: "column", gap: "2xs", children: [

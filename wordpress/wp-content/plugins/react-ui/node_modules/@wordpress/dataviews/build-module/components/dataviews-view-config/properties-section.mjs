...
function FieldItem({
  ...
  return /* @__PURE__ */ jsx(Item, { onClick: field.enableHiding ? onToggleVisibility : void 0, children: /* @__PURE__ */ jsxs(Stack, { direction: "row", gap: "xs", justify: "flex-start", align: "center", children: [

...
function ActionButtons({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ui.Stack, { direction: "row", gap: "2xs", children: actions.map((action) => {
...
function DataViewsPickerFooter() {
  ...
  const message = selectionCount > 0 ? (0, import_i18n.sprintf)(
    ...
    /* translators: %d: number of items. */
    (0, import_i18n._n)("%d Item", "%d Items", data.length),
    data.length
  );

  ...
  (0, import_element.useEffect)(() => {
    if (isTouched) {
      const timeoutId = setTimeout(() => {
        if (validity) {
          setCustomValidity((0, import_get_custom_validity.default)(isValid, validity));
        } else {
          validateRefs();
        }
      }, 0);
    ...
    ValidatedDateControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_components.BaseControl,
        {
          ...
          label: displayLabel,
          hideLabelFromVision,
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ui.Stack, { direction: "column", gap: "md", children: [

...
function ActionsMenuGroup({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Menu.Group, { children: [
    ...
    primaryActions.length > 0 && regularActions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu.Separator, {}),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    import_ui.Stack,
    {
      ...
      children: [
        ...
        primaryActions.length < eligibleActions.length && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          CompactItemActions,
          {
            item,
            actions: eligibleActions,

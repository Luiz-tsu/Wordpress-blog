...
export default function ValidatedText<Item>({ data, field, onChange, hideLabelFromVision, type, prefix, suffix, validity, }: DataFormValidatedTextControlProps<Item>): import("react").JSX.Element;

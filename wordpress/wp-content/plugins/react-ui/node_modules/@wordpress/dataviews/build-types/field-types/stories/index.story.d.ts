...
type ControlTypes = 'default' | 'array' | 'checkbox' | 'color' | 'date' | 'datetime' | 'email' | 'integer' | 'number' | 'password' | 'radio' | 'select' | 'telephone' | 'url' | 'text' | 'toggle' | 'toggleGroup';
...
export declare const DateTimeComponent: {
    ({ type, Edit, asyncElements, formatDatetime, formatWeekStartsOn, }: {
        type: PanelTypes;
        Edit: ControlTypes;
        asyncElements: boolean;
...
export declare const DateComponent: {
    ({ type, Edit, asyncElements, formatDate, formatWeekStartsOn, }: {
        type: PanelTypes;
        Edit: ControlTypes;
        asyncElements: boolean;
        formatDate?: string;

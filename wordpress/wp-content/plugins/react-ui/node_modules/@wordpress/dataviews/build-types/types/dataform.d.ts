...
export type CardSummaryField = PanelSummaryField | Array<string | {
    id: string;
...
export type Layout = RegularLayout | PanelLayout | CardLayout | RowLayout | DetailsLayout;
export type NormalizedLayout = NormalizedRegularLayout | NormalizedPanelLayout | NormalizedCardLayout | NormalizedRowLayout | NormalizedDetailsLayout;
export type NormalizedSummaryField = NormalizedPanelSummaryField | NormalizedCardSummaryField;
